...
<div class="h-screen w-full bg-bg_yellow absolute inset-0 bg-[radial-gradient(#e0c660_1px,transparent_1px)] [background-size:16px_16px]">
    <div class="w-full container mx-auto text-primary_text h-[85%]">
        ...
        <div class="h-[80%] flex flex-col justify-center items-center">
            <h1 class="text-3xl font-semibold my-6 text-center text-red">An Error occurred. Please Try again.</h1>
            <a href="/register"><button class="rounded-lg w-[190px] h-[75px] p-6 bg-btn_blue text-primary_text text-xl hover:underline hover:cursor-pointer hover:font-bold transition-all">Register</button></a>
        </div>
    </div>
